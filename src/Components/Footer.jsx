...
function Footer() {
  return (
    <div data-scroll data-scroll-speed="-.1" className=" text-[#212121] lg:flex-row flex-col w-full px-4 lg:px-10 py-16 rounded-tr-3xl lg:gap-20 flex ">
      <div className="flex flex-col lg:justify-between ">
        <h1 className="lg:text-[9vw] text-[20vw] w-1/2 leading-[16vw] lg:leading-[6.5vw] font-bold font-[Founders] ">
          EYE- OPENING
        </h1>
      ...
      <div className="right ">
        <h1 className="pb-20 text-[20vw] leading-[16vw] lg:text-[9vw] lg:leading-[6.5vw] font-bold font-[Founders] ">
          PRESENTATIONS
        </h1>

        <div className="flex items-center justify-between">
          <div className="flex text-[#212121] flex-col gap-2 font-[NeuMontreal] ">
            {[
              "S:",
              "",
              "Instagram",
        ...
        <svg className="lg:hidden flex mt-20"
          width="72"
          height="30"
          viewBox="0 0 72 30"
          fill="none"
