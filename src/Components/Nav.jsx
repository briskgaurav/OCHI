...
function Nav() {
  ...
  return (
    <>
      ...
      <motion.div initial={{y:"-100px"}}  animate={{y:"0px"}} className="bg-transparent w-full  px-10 lg:px-14 m-auto py-4 flex items-baseline justify-between font-[NeuMontreal]">
        <div>
          <svg
            width="72"
            height="30"
        ...
        <div  className="hidden lg:flex gap-8 font-extralight text-zinc-800">
          {["Services", "Our work", "About us", "Insights", "Contact us"].map(
            (elem, index) => (
              <motion.a whileHover={{textDecoration:"underline", color:"#27272a"}}
                className={`text-md ${index == 4 && "ml-52"}`}
                key={index}
                href="#"
              >
                {elem}
        ...
        <span className="text-3xl flex  lg:hidden">
          <RiMenu3Line />
        </span>
      </motion.div>
    </>
